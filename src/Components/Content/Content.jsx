            ...
            <div className="todo-box">
                ...
                <form onSubmit={handleSubmit}>
                   <div className="item1">
                    ...
                    <input className="input-box" type="text" id="title" placeholder="Title of Your To Do?" value={title} onChange={(e)=>setTitle(e.target.value)} />
                   </div>
                   <div className="item2">
                    <label className="input-box" htmlFor="description">Description:</label>
                    <input className="input-box" type="text" id="description" placeholder="Description of Your To Do?" value={desc} onChange={(e)=>setDesc(e.target.value)} />
                   </div>
                   <div className="item3">
